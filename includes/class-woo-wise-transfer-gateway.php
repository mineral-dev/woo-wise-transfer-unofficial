...
class Woo_Wise_Transfer_Gateway extends WC_Payment_Gateway {
	...
	public function enqueue_checkout_assets() {
		if ( ! is_checkout() && ! is_wc_endpoint_url( 'order-received' ) && ! is_order_received_page() && ! is_wc_endpoint_url( 'orders' ) && ! is_account_page() ) {
			return;
		}
	...
	public function thankyou_page( $order_id ) {
		...
		// Extract gateway settings into local vars for the partials.
